...
export function updatedUserPhone(data) {
  return http.post(`/user/updatedUserPhone`, data)
}
// 更新用户密码
export function updatedUserPassword(data) {
  return http.post(`/user/updatedUserPassword`, data)
}
// 修改好友备注
export function modifyFriendRemark(data) {
  return http.post(`/user/modifyFriendRemark`, data)
}
// 更新用户会话列表
export function updateUserConversations(data) {
  return http.post(`/user/updateUserConversations`, data)
}
// 删除用户会话列表的某个对话
